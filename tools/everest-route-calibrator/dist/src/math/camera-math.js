...
export function geodToWorld(geo) {
    return {
...
export function worldToCamera(p, pose) {
...
/** 世界点 → [原图像素]（可用于反向渲染遮罩） */
export function projectWorldToPixel(p, pose, intr) {
...
export function solveCameraPose(observations, init, imageWidth, imageHeight, freedom) {
    const free = [
        "yaw",
        "pitch",
        "roll",
