...
import {
  ...
  type ProjectedPoint,
  type RoutePoint,
} from "/home/hans/Code/self-github/geo-explorer/tools/everest-route-calibrator/src/calibrate.js";
...
const img = el<HTMLImageElement>("image");
...
function drawScene(): void {
  ...
  // waypoints 圆点
  if (el<HTMLInputElement>("show-wm").checked) {
