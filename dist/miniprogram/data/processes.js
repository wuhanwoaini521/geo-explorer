...
exports.KNOWLEDGE_PROCESSES = void 0;
exports.getKnowledgeProcess = getKnowledgeProcess;
exports.processForTopic = processForTopic;
const NOAA = {
...
function getKnowledgeProcess(id) {
    return exports.KNOWLEDGE_PROCESSES.find((process) => process.id === id);
}
function processForTopic(topicId) {
    return exports.KNOWLEDGE_PROCESSES.find((process) => process.topicId === topicId);
}
