...
exports.MARIANA = {
    ...
    meta: {
        ...
        region: "西太平洋 · 马里亚纳群岛",
        typeLabel: "超深渊 / 海洋",
        description: "地球海洋最深处（挑战者深渊，约 10,935 m）。从明亮的海面一路沉入微光、黑暗与超深渊——6 个海洋带，每 10m 水压增加一个大气压。",
        ...
        waypoints: [
            {
                ...
                detail: "马里亚纳海沟远离陆地，最近的关岛也在西南约 300 km 外。载人下潜通常以科考母船为基地：清晨完成气象与海流评估后，潜水器（如「奋斗者」号、Limiting Factor）经起重机放入海中，随后脱离母船自主下沉。海面到万米深渊没有任何「台阶」——一路都是水，这也是深海探索最难的地方：所有保护都来自潜水器本身。",
                facts: [
                ...
                history: "挑战者深渊得名于 1872–76 年英国「挑战者号」科考船的首次系统测深；此后的每一次深潜（1960 / 2012 / 2020）都以这样的母船—潜水器接力开场。",
            ...
            },
            {
                ...
                detail: "温跃层是海水温度随深度急剧变化的薄层，也是阳光带（0–200 m）的底界。热带海域温跃层通常在 100–200 m 之间；穿过它，水温和密度同步骤变，声波传播路径也随之弯折——这也是潜艇「躲」进温跃层的原因。阳光到 200 m 处只剩不到 1%，浮游植物的光合作用在此基本停摆。",
                facts: [
                    "温跃层：热带海域通常在 100–200 m（NOAA）",
                    "200 m 处光照不足表层的 1%（NOAA）",
                ],
                environment: "水温从 20 ℃ 级降到 10 ℃ 级；阳光迅速变暗，颜色从蓝绿转向深蓝。",
                history: "温跃层是海军声学与潜艇战术的经典课题：声速在跃层两侧突变，声呐波束会在此弯折甚至形成「阴影区」。",
            ...
            },
            {
                ...
                detail: "微光带（200–1,000 m）是阳光的「余晖区」：光量随深度指数衰减，到 1,000 m 彻底归零。这条无光界也是深海生态的分水岭——以上的动物靠视觉与昼夜垂直迁移谋生，以下的居民只能靠化学发光与「海雪」。世界上最大的动物迁徙（垂直迁移）每晚就发生在这一带：数百万吨的中层鱼类夜里上浮到表层觅食，天亮前退回黑暗。",
                facts: [
                    "无光界：约 1,000 m（阳光完全消失，NOAA）",
                    "中层带多数动物具备自体发光能力（近似）",
                ],
                environment: "水温约 4–5 ℃；水压约 100 个大气压；窗外已看不到任何自然光。",
                history: "1950 年代以来，「声呐层」探明的中层带鱼类垂直迁移被称为地球上最大规模的动物迁徙——直到 20 世纪中叶，科学界才确认这片黑暗水柱里藏着如此巨大的生物量。",
            ...
            },
            {
                ...
                detail: "深层带（1,000–4,000 m）的水温已接近极小值层（约 1.4–2 ℃）：这是表层冷水下沉、深海环流的「水龄」最老的水团之一。阳光完全缺席，食物全部依赖上层的「海雪」——浮游生物尸体、粪粒与碎屑缓慢下沉，为这里的零星居民（章鱼、灯笼鱼、端足类）提供能量。全球深渊平原约四分之三的洋底都在这个深度附近。",
                facts: [
                    "水温约 1.4–2 ℃（温度极小值层）",
                    "水压约 400 个大气压",
                ],
                environment: "完全黑暗，水温约 1.4–2 ℃，接近海水冰点；食物供给全球海洋最低。",
                history: "「深层水」是海洋环流的终点站：北大西洋与南极底层水下沉后，要在这里「住」上千年量级才会重新回到表层——深海环流研究的钥匙就在这段水柱里。",
            ...
            },
            {
                ...
                detail: "6,000 m 是超深渊带（Hadal zone）的门槛——只有海沟能到达这个深度。从深渊平原继续下潜，海底坡度明显变陡：太平洋板块正在菲律宾海板块之下俯冲，海沟的内壁就是俯冲带的斜坡。这里的居民进一步特化：狮子鱼（hadal snailfish）等顶住了 600 多个大气压。",
                facts: [
                    "超深渊门槛：6,000 m（仅海沟能到达）",
                    "水压约 650 个大气压",
                ],
                environment: "水温约 1.6–2 ℃；斜坡沉积物松软，随时有小型滑坡把泥沙送进沟底。",
                history: "海沟斜坡也是地震的舞台：俯冲带在此把太平洋板块拉入地幔，历史上多次深海地震的震源就分布在两侧坡体之内。",
            ...
            },
            {
                ...
                detail: "接近万米时，潜水器抛下压载后下潜速度放缓，探照灯打进一片死寂的浑浊水中。海沟底部的沉积物厚达公里级（由上层滑落与远洋沉积堆积），灯光常被海底雾（benthic storm 掀起的沉积物云）遮挡。这里的水压已超过 970 个大气压——任何气泡空腔都会被压扁到极限。",
                facts: [
                    "水压约 970+ 个大气压",
                    "水温约 2 ℃（近底略有回升）",
                ],
                environment: "近底水温因绝热压缩略有回升（约 2 ℃）；声呐上沟底地形起伏复杂。",
                history: "2019 年 Victor Vescovo 驾驶 Limiting Factor 下潜至此深度带并继续坐底——这是人类首次以可重复载人潜水器抵达万米沟底，此后该船又完成多次万米科考下潜。",
            ...
            },
            {
                ...
                detail: "挑战者深渊是马里亚纳海沟最深处的盆地，2021 年基于压力计与声学测量深度为 10,935 ± 6 m（Greenaway et al. 2021），是目前公认的地球海洋最深点。海底铺着极细的乳白色沉积（远处漂浮的硅藻软泥），水压约 1,086 个大气压——相当于每平方厘米压着约 1.1 吨的重量。即便如此，这里仍有生命：端足类在探照灯前游动，海沟狮群鱼在 8,000 m 以下仍有记录。",
                facts: [
                ...
                history: "1960 年的里雅斯特号首次在此坐底；2020 年 11 月中国「奋斗者」号坐底 10,909 m——两次跨越 60 年的坐底，见证深潜技术从铆接钢球到钛合金载人舱的整整一代技术更替。",
    ...
    knowledgeNodes: [
        {
            ...
            detail: "微光带开始，生物发光逐渐成为主流。深海动物大多依靠体内的荧光素-荧光素酶反应发出蓝绿色光（这种波长在水中传播最远），用来吸引猎物、警示天敌或与同类交流——在阳光到不了的世界里，光就是语言。公开研究的统计显示，0–4,000 m 水层的浮游与游泳动物中约四分之三具备发光能力（近似）。",
            facts: [
        ...
        },
        {
            ...
            detail: "阳光在表层耗光殆尽：约 200 m 处仅余 1% 光量，约 1,000 m 以下完全无光。\n" +
        ...
        },
        {
            ...
            detail: "深渊带水温接近冰点（约 1–4 ℃），食物供给极低，深海生命只能靠极稀薄的食物碎屑维持。这里没有光合作用，许多鱼类的眼睛退化或消失，仅靠触觉与嗅觉在永恒的黑暗中猎食。",
            facts: [
        ...
        },
        {
            ...
            detail: "大气压按每 10 m ~1 个大气压线性累积。到 4,000 m 时已约 400+ 个大气压，挑战者深渊处超过 1,000 个大气压（约 1,086 atm / 15,750 psi），远超地面上的任何极限。",
            facts: [
        ...
        },
        {
            ...
            detail: "超深渊带只见于大洋里最深的海沟。马里亚纳海沟形成于太平洋板块向菲律宾海板块之下俯冲，是全球最深的海沟；挑战者深渊在其南端，深达约 10,935 m。",
            facts: [
        ...
        },
        {
            ...
            category: "历史",
            summary: "1960 年的里雅斯特号首度载人抵达挑战者深渊；2012 卡梅隆独自下潜；2020 中国「奋斗者」号坐底 10,909 m。",
            detail: "1960 年 1 月 23 日，瑞士造的「的里雅斯特号」载人潜水器由皮卡德与沃尔什驾驶，下潜至约 10,916 m，第一次把人类带入深渊。\n\n2012 年《泰坦尼克》导演詹姆斯·卡梅隆独自驾驶「深海挑战者」号抵达约 10,908 m。\n\n2020 年 11 月，中国「奋斗者」号在挑战者深渊成功坐底（深度 10,909 m），创下中国载人深潜纪录。",
            facts: [
