...
exports.MARIANA = {
    ...
    knowledgeNodes: [
        ...
        },
        {
            ...
            detail: "微光带开始，生物发光逐渐成为主流。约 90% 的微光与深海动物可通过自身体内的化学发光（荧光素酶）发出蓝绿色光，用来吸引猎物、警示敌人，或向同类求偶——深海几乎是「LED 的世界」。",
            facts: [
        ...
        },
        {
            ...
            detail: "深渊与接近冰点的水温、硫深海生命只能靠极低的食物供给维持。这里没有光合作用，许多鱼类的眼睛退化或消失，仅靠触觉与嗅觉在永恒的黑暗中猎食。",
            facts: [
        ...
        },
        {
            ...
            detail: "超深渊带只见于大洋里最深的海沟。马里亚纳海沟形成于太平洋板块向马里亚纳-岛弧之下俯冲，是全球最深的海沟；挑战者深渊在其南端，深达约 10,935 m。",
            facts: [
        ...
        },
        {
            ...
            category: "历史",
            summary: "1960 年的里雅斯特号首度载人抵达挑战者深渊；2012 卡梅隆独自下潜；2020 中国奋斗号下潜 10,909 m。",
            detail: "1960 年 1 月 23 日，瑞士造“的里雅斯特号”载人潜水器，由皮卡德与沃尔什下潜至约 10,916 m，第一次把人类带入深渊。\n\n2012 年《泰坦尼克》导演詹姆斯·卡梅隆独自驾驶“深海挑战者”号抵达约 10,908 m。\n\n2020 年 11 月，中国“奋斗者”号在 10,909 m 成功坐底，多人再创我国载人深潜纪录。",
            facts: [
        ...
        },
        {
            ...
            title: "挑战者深渊 · 地球最深点",
            category: "世界地理",
            summary: "马里亚纳海沟东南一角（挑战者深渊）约 10,935 m，是目前地球海中的最深点。",
