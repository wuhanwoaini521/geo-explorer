...
exports.EVEREST_BAND = exports.EVEREST = void 0;
const SRC_ZH_2020 = {
...
exports.EVEREST = {
    ...
    meta: {
        ...
        region: "喜马拉雅山脉",
        typeLabel: "高山地貌",
        description: "世界最高峰（8,848.86 m）。从亚热带林带一路穿过针叶林、草甸、高山荒漠到永久积雪，在一条海拔剖面上看完整个地球的垂直自然带。",
        ...
        waypoints: [
            {
                ...
                detail: "南坡大本营驻扎在昆布冰川的冰面上，海拔约 5,364 m，是徒步终点也是攀登起点。登山队在此完成装备检查、冰川行走训练与高原适应；此后所有物资都由牦牛队与人力运抵这里，再向更高营地转运。",
                facts: [
                    "海拔约 5,364 m，位于缓慢流动的昆布冰川表面",
                    "帐篷区建在冰面上，会随冰体位移而需要重新平整",
                    "南坡路线的补给与高原适应中枢",
                ],
                environment: "海拔 5,364 m 的冰碛平台上，盛夏白天约 -8 ℃，夜间更低；空气含氧量约为海平面的 53%，多数人到这里的头两天以休息适应为主。",
                risk: "高原反应从徒步段就可能出现；大本营的帐篷城随冰川缓慢移动，地面持续变形，须留意帐绳与裂隙。上方冰瀑的崩塌声在夜里清晰可闻。",
                history: "1953 年希拉里与丹增首次登顶的远征以此为前进基地；此后 70 余年，南坡大本营一直是喜马拉雅攀登的标志性场景，营地本身建在缓慢流动的昆布冰川冰面上。",
                whatToNotice: "看脚下：营地的冰碛石来自冰川沿途搬运；凌晨与傍晚观察冰瀑方向的崩塌声与烟尘，那是冰体在移动的证据。",
            ...
            },
            {
                ...
                detail: "昆布冰川在陡坎处断裂成数百座冰塔、深裂隙与不稳定的冰桥。冰体每天仍在缓慢移动，地形随之改变，因此每个登山季都要由修路队重新架设铝梯与固定绳。这是南坡最危险、也最需要快速通过的一段。",
                facts: [
                    "冰川在自重下持续流动，冰塔与裂隙位置不断变化",
                    "多数队伍选择凌晨气温最低时通过，降低冰体崩塌风险",
                    "跨越裂隙主要依靠铝梯与固定绳",
                ],
                environment: "冰川陡坎上的移动冰塔区，海拔 5,400–6,000 m；气温在凌晨最低（约 -10 ℃ 级），此时冰体最稳定。",
                risk: "全路线最危险的一段：冰瀑崩塌、冰桥断裂与裂隙坠落构成持续威胁；多数队伍选择凌晨快速通过，不在此恋战。",
                history: "1950-51 年霍顿·赖特与夏尔巴向导首次确认可从冰瀑穿越进入西库姆——这条「冰电梯」正是南坡路线成立的前提；每年由「冰瀑医生」团队重新架设铝梯与固定绳。",
                whatToNotice: "观察冰塔的「层流」痕迹与裂隙走向：冰体沿基岩陡坎断裂成块，裂隙的排列方向暴露了冰川的流动方向。",
            ...
            },
            {
                ...
                detail: "C1 位于昆布冰瀑顶端、冰川谷地的缓雪坡上，海拔约 6,065 m。队伍通过冰瀑后在此短暂停留、补充水分，然后继续向珠峰与洛子峰之间的西库姆冰谷推进。",
                facts: [
                    "海拔约 6,065 m",
                    "位于冰瀑之上、西库姆冰谷入口",
                    "通常作为通过冰瀑后的第一个短停点",
                ],
                environment: "海拔约 6,065 m 的雪原谷地，含氧量约为海平面的 47%；白天雪面反射强烈，夜间辐射冷却极快。",
                risk: "冰瀑仍在头顶：C1 的危险性主要来自上方冰体；停留时间宜短，物资尽早转运。",
                history: "1952 年瑞士远征首次打通冰瀑抵达此处（未登顶）；自那以后 C1 一直是每个攀登季的第一个高海拔宿营点。",
                whatToNotice: "看谷地两侧的冰碛：珠峰西南壁与努子峰之间的谷底仍属冰川系统，冰面融水在正午形成小溪流。",
                knowledgeIds: ["k08"],
            ...
            },
            {
                ...
                detail: "西库姆（Western Cwm）是珠峰与洛子峰之间的宽阔冰川盆地，被英国登山者称作「寂静之谷」。谷内积雪强烈反射阳光，白天的体感温度可远高于同海拔的开阔风区；它同时也是南坡适应与补给的关键一站。",
                facts: [
                    "海拔约 6,500 m 的宽阔雪谷",
                    "两侧分别是珠峰西南壁与洛子峰北壁",
                    "强烈日照反射使谷内体感温度偏高",
                ],
                environment: "海拔约 6,500 m 的宽阔雪谷：阳光经两侧冰雪强烈反射，谷内白昼体感温度可明显高于同海拔的开阔风区，紫外线几乎无衰减。",
                risk: "「雪盲」与脱水是西库姆的隐形风险；洛子壁下缘的雪崩通道需按通行窗口通过；夜间气温可到 -20 ℃ 量级。",
                history: "1952 年瑞士远征队率先进入西库姆（Shangri-La 之名即出自他们），这里从此成为南坡适应训练的核心营地。",
                whatToNotice: "留意两侧壁的对比：左侧珠峰西南壁陡峻，右侧洛子峰北壁平直高耸——洛子壁就是通往 C3 与南坳的「墙」。",
                knowledgeIds: ["k02"],
                sources: [SRC_WIKI_EVEREST],
                reviewStatus: "approved",
            ...
            },
            {
                ...
                detail: "洛子壁是通往南坳的一段连续冰坡，坡度陡、冰面硬，攀登全程沿固定绳行进。C3 就挂在冰坡上的窄平台，海拔约 7,200 m；再向上便是南坳，以及 8,000 m 死亡区的边缘。",
                facts: [
                    "海拔约 7,200 m 的持续陡坡",
                    "全程铺设固定绳，需使用冰爪与上升器",
                    "进入南坳前最后一个常规营地",
                ],
                environment: "连续陡峭冰壁上的窄平台，海拔约 7,200 m；含氧量约为海平面的 42%，气温常在 -15 ℃ 以下。",
                risk: "滑坠是最大威胁：硬冰雪坡全程依赖固定绳与上升器；洛子壁亦常有落石与流雪，C3 的帐篷挂在小平台上，暴露感极强。",
                history: "1953 年英国远征经此推进至南坳；C3 一带的地形自那以后变化不大，但冰况逐年不同，修路质量直接决定通过速度。",
                whatToNotice: "看固定绳的走向：绳路每隔数米打结固定在冰锥上，攀登者以「jumar（上升器）」逐结上移——冰壁的地形决定了绳的位置。",
                knowledgeIds: ["k07"],
                sources: [SRC_WIKI_EVEREST],
                reviewStatus: "approved",
            ...
            },
            {
                ...
                detail: "南坳是珠峰与洛子峰之间的鞍部，海拔约 7,906 m，常年强风。冲顶前的最后一晚通常留在这里：队伍在夜色中出发，向上便进入 8,000 m 以上的死亡区，氧气与体能都开始按分钟计算。",
                facts: [
                    "海拔约 7,906 m 的鞍部营地",
                    "位于珠峰与洛子峰之间，风大而暴露",
                    "冲顶通常从此处凌晨出发",
                ],
                environment: "海拔约 7,906 m 的鞍部：常年强风，含氧量约为海平面的 40%，体感温度远低于气温——这里被称为「登山者的赌场」。",
                risk: "冲顶前最后的宿营点：强风掀翻帐篷、夜间冻结与急性高原反应都在这里发生；冲顶窗口一旦错过，就只能等待下一个周期。",
                history: "1952 年瑞士队首抵南坳（未登顶）；1953 年希拉里与丹增从南坳出发完成人类首次登顶。此后南坳成为所有南坡冲顶的起点与退守地。",
                whatToNotice: "看两侧：珠峰一侧是「黄色带」的岩层露头，洛子一侧是断崖；风从鞍部横穿而过，帐篷旗绳几乎始终指着同一方向。",
            ...
            },
            {
                ...
                detail: "南峰是主峰之前最后一道凸起，海拔约 8,749 m。翻过南峰后是一段暴露的雪脊，两侧皆为陡崖；希拉里台阶就在这段路上。峰顶已经在视野里，但体能与氧气也接近极限，绝大多数事故都发生在这段往返之中。",
                facts: [
                    "海拔约 8,749 m，与主峰高差约 100 m",
                    "雪脊两侧为陡崖，风大且暴露",
                    "希拉里台阶位于南峰与主峰之间",
                ],
                environment: "海拔约 8,749 m 的雪脊：含氧量约为海平面的 34%，风速大且暴露感极强；天气窗口极短。",
                risk: "雪脊两侧皆为千米断崖，风与缺氧在此叠满；2015 年地震后希拉里台阶地形发生变化，路线难度与风险相应调整。",
                history: "南峰是 1953 年首登路线的最后难关之一：希拉里正是在这段岩缝（后称「希拉里台阶」）完成了关键攀爬。",
                whatToNotice: "回头看一眼来路：南坳与洛子壁缩成一条线——这也是判断「是否还有体力继续」的最后参照点。",
            ...
            },
            {
                ...
                detail: "地球海拔最高点。2020 年 12 月，中国与尼泊尔联合公布最新高程 8,848.86 m。峰顶气压约 335 hPa，含氧量不足海平面的三分之一，登山者通常只能停留很短时间，随后必须尽快下撤。",
                facts: [
                    "2020 年联合公布高程 8,848.86 m",
                    "峰顶气压约 335 hPa ≈ 海平面的三分之一",
                    "停留时间通常仅数十分钟，天气窗口极短",
                ],
                environment: "海拔 8,848.86 m：气压约 335 hPa（海平面约 1/3），含氧量不足海平面的 1/3，盛夏白昼气温也在 -25 ℃ 以下。",
                risk: "死亡区的顶端：高原肺水肿/脑水肿、失温与判断力下降随时可能发生；停留时间通常只有数十分钟，随后必须尽快下撤。",
                history: "1953-05-29 希拉里与丹增首次登顶；2020-12-08 中尼联合公布最新高程 8,848.86 m——峰顶曾是特提斯海的海底，如今是地球海拔最高的点。",
                whatToNotice: "看脚下的石灰岩：峰顶岩石是约 4 亿年前海底沉积的灰岩；向北望去，整个青藏高原在云层之上展开。",
    ...
    stages: [
        ...
        },
        {
            ...
            surfaceKind: "glacier",
            flora: ["🧊", "🗻", "❄️"],
            description: "昆布冰瀑是南坡大本营以上真正的第一道险关，冰川在脚下缓慢流动、不断崩裂。",
        },
        {
            id: "south-col",
            elevation: 7900,
            ...
            surfaceKind: "death",
            flora: ["⛰️", "🪨", "❄️"],
            description: "约 7,900m 的最后冲顶营地；整装后再向上，才会真正跨入 8,000m 死亡区。",
        },
        {
            id: "death-zone",
            elevation: 8000,
        ...
        },
        {
            ...
            surfaceKind: "snow",
            flora: ["🏔️", "❄️", "🪨"],
            description: "跨过南峰，最终雪脊两侧都是千米断崖；风把积雪吹成旗云，峰顶已在前方。",
        },
        {
            id: "summit",
            elevation: 8848.86,
    ...
    knowledgeNodes: [
        {
            ...
            title: "为什么南坡林带这么高？",
            category: "气候",
            summary: "印度洋暖湿季风在翻越 7,000m 山峰前，在南坡制造了超长的湿润森林带。",
            detail: "喜马拉雅南坡正对着印度洋，夏季风带来大量水汽、受地形抬升成云致雨，因此南坡从山脚直到约 4,000 米都被常绿阔叶林、针叶林和杜鹃灌丛覆盖，而同海拔的北坡（西藏侧）却大都是荒原。",
            facts: [
                {
                    label: "南坡林带上限",
            ...
            quiz: {
                ...
                answerIndex: 0,
                explanation: "南坡面对孟加拉湾与印度洋，夏季风气流被地形强烈抬升、成云致雨，形成高降水带；北坡背风少雨，多为荒原草甸。",
                emoji: "🌧️",
                source: SRC_WIKI_EVEREST,
            },
        },
        {
            ...
            detail: "对流层内的平均温度直减率约 6.5℃/1000m：你每升高一公里，周围空气就冷约 6-7℃。这也就是为什么同一天，山脚可以穿短袖，峰顶却是零下几十度。",
            facts: [
                {
                    label: "标准直减率",
        ...
        },
        {
            ...
            detail: "海拔越高，气温越低、风越大、生长季越短，树木首先扛不住，形成树线（南坡约 4,000–4,300m）。树线上方是无林的高山草甸；再往上是裸露的裸岩与冰雪世界——高山乔木变成矮林、灌丛与草甸。",
            facts: [
                {
                    label: "南坡树线",
            ...
            quiz: {
                ...
                answerIndex: 0,
                explanation: "树木受低温、大风与生长季太短限制，南坡树线约在 4,000–4,300m；之上是灌木、草甸最后过渡到裸岩与冰雪。",
                emoji: "🪵",
                source: SRC_WIKI_EVEREST,
            },
        },
        {
            ...
            detail: "雪线是“永久积雪”的下界；雪线上方哪怕在最热的夏季，降雪的量也大于消融，于是积雪年复一年压实成冰。珠峰南坡雪线约在 5,000–5,500m——从这一刻起，脚下失去大部分色彩，变成「冰与岩」的世界。",
            facts: [
                {
                    label: "南坡雪线",
            ...
            quiz: {
                ...
                answerIndex: 0,
                explanation: "雪线是常年积雪的下界，其上方积雪终年不融化、逐年压成冰并形成冰川。",
                emoji: "❄️",
                source: SRC_WIKI_EVEREST,
            },
        },
        {
            ...
            detail: "位于大本营与 C1 之间的昆布冰川是珠峰南麓最著名的冰川。积雪在自重下缓慢压实成冰，冰体在重力作用下不断向下流动，几年的时间就能走过公里级别的距离；因此表面布满裂隙与冰塔，地貌随时变化，攀登难度极大。",
            facts: [
                {
                    label: "昆布冰川范围",
            ...
            quiz: {
                ...
                answerIndex: 0,
                explanation: "冰川是高压缩的塑性冰体，在重力驱动下以缓慢速度流动（数年十年走完公里级），因此表面充满裂隙并不断变化。",
                emoji: "🧊",
                source: SRC_GLACIER,
            },
        },
        {
            ...
            detail: "在 8,000m 以上的「死亡区（Death Zone）」，气压仅约海平面的三成，人体几乎无法靠自然呼吸维持长期生存——细胞缺氧、判断力下降，甚至各器官衰竭。这就是为什么登顶前后要在“出击窗口”中速战速决。",
            facts: [
                {
                    label: "8,848m 峰顶气压",
            ...
            quiz: {
                ...
                answerIndex: 0,
                explanation: "峰顶气压约 335 hPa，约为海平面（1,013 hPa）的 1/3，故 8,000m 以上被称为“死亡区”。",
                emoji: "🫁",
                source: SRC_O2,
            },
        },
        {
            ...
            detail: "2020 年 12 月 8 日，中尼双方联合发布最新高程：**8848.86 m**，取代此前两队的 8844.43m（中国测）与 8848m（英/尼历）。测量结合卫星定位（GNSS）、微波测距、雪深雷达等方法，并首次统一两国基准换算。",
            facts: [
                {
                    label: "官方高程",
...
exports.EVEREST_BAND = {
    from: exports.EVEREST.startElevation,
    to: exports.EVEREST.maxElevation,
};
