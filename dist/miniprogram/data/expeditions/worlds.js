...
exports.WORLD_EXPEDITIONS = exports.COLORADO_EXPEDITION = exports.FUJI_EXPEDITION = exports.MARIANA_EXPEDITION = void 0;
const index_1 = require("../explorations/index");
const world_manifests_1 = require("../media/world-manifests");
const world_expedition_1 = require("./world-expedition");
function world(id) {
    const found = index_1.EXPLORATIONS.find((e) => e.id === id);
    if (!found)
        throw new Error(`[world-expeditions] 未找到世界：${id}`);
    return found;
}
/** 阶段命名沿用探索数据；段数 = 里程碑间隔数（多余的历史阶段丢弃）。 */
function stagesOf(ex) {
 ...
 * 避免主视觉又滑回科研图。
 */
function liveAsset(manifest, sourceId) {
    const src = manifest.assets.find((a) => a.id === sourceId);
    if (!src)
        throw new Error(`[world-expeditions] 源资产不存在：${sourceId}`);
...
function liveManifest(id, sceneId, asset) {
    return {
        schemaVersion: 1,
        id,
        sceneId,
        assets: [asset],
        notes: "非珠峰世界：LIVE 主视觉实景资产；TERRAIN 与 LIVE 共用同一张实景图（该世界无独立 DEM 影像）。",
    };
}
...
exports.MARIANA_EXPEDITION = (0, world_expedition_1.buildWorldExpedition)(world("mariana"), {
    type: "DIVE",
    ...
    media: liveManifest("mariana-expedition-media", "mariana", liveAsset(world_manifests_1.MARIANA_MANIFEST, "k40-ifremer-snow")),
...
/* 富士山 —— 攀登                                                          */
/* ------------------------------------------------------------------ */
exports.FUJI_EXPEDITION = (0, world_expedition_1.buildWorldExpedition)(world("fuji"), {
    type: "CLIMB",
    ...
    media: liveManifest("fuji-expedition-media", "fuji", liveAsset(world_manifests_1.FUJI_MANIFEST, "f-osunabashiri")),
...
/* 科罗拉多大峡谷 —— 下切                                                   */
/* ------------------------------------------------------------------ */
exports.COLORADO_EXPEDITION = (0, world_expedition_1.buildWorldExpedition)(world("colorado"), {
    type: "CUTAWAY",
    ...
    media: liveManifest("colorado-expedition-media", "colorado", liveAsset(world_manifests_1.COLORADO_MANIFEST, "c2-devils-corkscrew")),
...
exports.WORLD_EXPEDITIONS = [
    exports.MARIANA_EXPEDITION,
    exports.FUJI_EXPEDITION,
    exports.COLORADO_EXPEDITION,
];
